...
package com.aspire.flow.helper;
...
public interface PathHelper {
    ...
    static String getJobPath(String jobParentPath, String flowId) {
        AssertHelper.notNull(jobParentPath, "jobParentPath can't be null.");
        AssertHelper.notNull(flowId, "group can't be null.");
        return jobParentPath + "/" + flowId;
    }
