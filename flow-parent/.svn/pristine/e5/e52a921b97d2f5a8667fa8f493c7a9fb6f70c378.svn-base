...
public class JDateChooser extends JPanel implements ChangeListener,
	...
	public JDateChooser(Calendar initialDate, StepType stepType) {
		...
		this.add(p2);
		setCalendar(initialDate, stepType);
	 ...
	 *            日期和时间
	 */
	public void setCalendar(Calendar calendar, StepType stepType) {
		if (calendar == null)
		...
		if (StepType.SECOND.equals(stepType.getStepType())) {
		} else if (StepType.MINUTE.equals(stepType.getStepType())) {
			calendar.set(Calendar.SECOND, 0);
		} else if (StepType.HOUR.equals(stepType.getStepType())) {
	...
	public static Calendar showDialog(Component c, String title,
			Calendar initialDate, StepType stepType) {
		...
		JDateChooser dc = new JDateChooser(initialDate, stepType);
	...
	public static void main(String[] args) throws Exception {
		...
		// Calendar c = JDateChooser.showDialog(null, "请选择日期", null,new
		// StepType);
